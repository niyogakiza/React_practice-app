...
import { StyleDesktopMenu, StyledMobileMenu, StyledIoNavicon, StyledIoClose} from "./styles";
...
class FixedMenu extends Component{
    ...
    renderMobileNavIcon(){
        ...
        return(
            <Container>
                { mobileVisible === false ? <StyledIoNavicon
                   size="30"
                   color="white"
    ...
    render(){
        ...
        return(
            <div>
                <StyleDesktopMenu fixed="top" size="large" inverted>
                    { this.renderMenuItems() }
                </StyleDesktopMenu>
                <StyledMobileMenu fixed="top" size="large" inverted stackable>
                    { this.renderMobileNavIcon() }
                    { mobileVisible === true && this.renderMenuItems()}
                </StyledMobileMenu>
            </div>
        );
    }
